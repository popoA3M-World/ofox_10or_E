...
#
	...
	export OF_MAINTAINER="popoASM"
	export OF_TARGET_DEVICES="land,holland2,vince,mido,msm8937,santoni,riva,E,G,holland1"
	export TARGET_DEVICE_ALT="land,holland2,vince,mido,msm8937,santoni,riva,E,G,holland1"
